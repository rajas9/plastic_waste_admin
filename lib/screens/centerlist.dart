                    ...
                    builder: (BuildContext context, AsyncSnapshot snapshot) {
                      if (!snapshot.hasData || snapshot.data == null) {
                        ...
                        for (var i = 0; i < 5; i++) {
                          ...
                          center_percentage[i] =
                              double.parse((j).toStringAsFixed(2));
                        }

                        return _buildDefaultColumnChart(
                            center_percentage, _tooltipBehavior);
...
SfCartesianChart _buildDefaultColumnChart(
    List center_percentage, TooltipBehavior _tooltipBehavior) {
  //var _tooltipBehavior;
  return SfCartesianChart(
    plotAreaBorderWidth: 0,
    title: ChartTitle(text: 'Plastic Waste Collection by centers'),
